...
public abstract class RecyclableCard extends Card {
    ...
    public RecyclableCard(String title, String titlePlay, String description,
                          String color, String titleColor, Boolean hasOverflow,
                          Boolean isClickable) {
        super(title, titlePlay, description, color, titleColor, hasOverflow, isClickable);
    }
